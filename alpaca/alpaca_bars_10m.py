...
try:
    ...
    spark = SparkSession.builder.appName("Alpaca 10 minutes bars").getOrCreate()
else:
...
if __name__ == "__main__":
    ...
    bar_storage_path = config[environment]["Bars10mPath"]

    window_duration = f"{WINDOW_SIZE} minutes"
    slide_size = f"{SLIDE_SIZE} minutes"
